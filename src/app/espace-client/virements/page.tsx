...
const ACCOUNTS = [
  { id: 1, label: "Compte Courant", balance: 12847.53, iban: "PL61 1090 1014 0000 0712 1981 2874" },
  { id: 2, label: "Livret Épargne", balance: 45230.00, iban: "PL27 1140 2004 0000 3002 0135 5387" },
  { id: 3, label: "Compte Pro", balance: 89415.22, iban: "PL10 1050 0099 7603 1234 5678 9012" },
];

const BENEFICIARIES = [
  { id: 1, label: "Anna Kowalska", iban: "PL83 1020 1026 0000 0422 0000 1234" },
  { id: 2, label: "Loyer appartement", iban: "PL44 1160 2202 0000 0002 4447 1234" },
  { id: 3, label: "Électricité PGE", iban: "PL92 1240 6247 1111 0010 4319 8745" },
];
...
export default function VirementsPage() {
  ...
  if (step === "done") {
    return (
      <div className="max-w-lg mx-auto text-center py-16">
        ...
        <p className="text-gray-500">Votre virement de <strong>{Number(amount).toLocaleString("fr-FR", { minimumFractionDigits: 2 })} PLN</strong> a été soumis avec succès.</p>
    ...
    return (
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <Row label="Montant" value={`${Number(amount).toLocaleString("fr-FR", { minimumFractionDigits: 2 })} PLN`} />
  ...
  return (
    <div className="max-w-lg">
      ...
      <p className="text-sm text-gray-500 mb-6">Virement SEPA en zone euro et Pologne</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        <div>
          ...
          <select value={source} onChange={(e) => setSource(e.target.value)}
            ...
            {ACCOUNTS.map((a) => (
              <option key={a.id} value={a.id}>{a.label} — {a.balance.toLocaleString("fr-FR", { minimumFractionDigits: 2 })} PLN</option>
            ))}
          </select>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Montant (PLN)</label>
